...
export default function Workspace() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      {/* 右栏：标注图 / 效果预览 */}
      <div className="w-1/2 bg-gray-900 flex flex-col items-center justify-center overflow-hidden">
        {annotatedImageUrl ? (
          <AnnotatedImagePanel url={annotatedImageUrl} />
        ) : (
...
function AnnotatedImagePanel({ url }: { url: string }) {
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex items-center gap-2 px-4 py-3 bg-gray-800 border-b border-gray-700 flex-shrink-0">
        ...
        <span className="ml-auto text-xs text-gray-500">MediaPipe 478 点</span>
      </div>
      {/* 图像 */}
